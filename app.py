...
st.set_page_config(page_title="📖 Talk to you Pdf 📖")
...
def main():
    ...
    st.divider()
    st.markdown("Created by Abhishek : [LinkedIN](https://www.linkedin.com/in/abhishekgupta2000/)")
    st.markdown("Created by Abhinav Shreyas : [LinkedIN](https://www.linkedin.com/in/abhishekgupta2000/)")
